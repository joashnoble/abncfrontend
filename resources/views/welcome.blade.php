			...
			<div class="grey-bg"> <!-- Grey BG  -->	
                ...
                <div class="logo-2">
                  <a href="index.html" class="clearfix">
                    <img src="haswell/images/logo.png" class="logo-img" alt="Logo">
                  </a>
                </div>
              </div>
						<!-- BUTTON --> 
                            ...
                            <div class="menu-sub-container">
                              ...
                              <div class="col-md-6 menu-map-container hide-max-960 ">
                                ...
                                <div class="google-map-container">
                                  <img src="haswell/images/map-line.png" alt="alt">
                                </div>
                                <!-- Google Maps / End -->	
                              </div>
				...
				<div class="relative">
					<div class="rs-fullscr-container">
						...
						<div id="rs-fullscr" class="tp-banner" >
							<ul>	
								<!-- SLIDE 1 -->
								<li data-transition="zoomout" data-slotamount="1" data-masterspeed="1500" data-thumb="haswell/images/revo-slider/rs-fullscr-thumb1.jpg"  data-saveperformance="on"  data-title="BEGIN">
									<!-- MAIN IMAGE -->
									 
									<img src="haswell/images/revo-slider/dummy.png"  alt="slidebg1" data-lazyload="haswell/images/revo-slider/slide_1_1.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
								...
								<!-- SLIDE 2 -->
								<li data-transition="zoomout" data-slotamount="1" data-masterspeed="1500" data-thumb="haswell/images/revo-slider/rs-fullscr-thumb2.jpg"  data-saveperformance="on"  data-title="IMAGINATION">
									
                  <!-- MAIN IMAGE -->
                  <img src="haswell/images/revo-slider/dummy.png"  alt="slidebg2" data-lazyload="haswell/images/revo-slider/slide_1_2.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
								...
								<!-- SLIDE 3 -->
								<li data-transition="zoomout" data-slotamount="1" data-masterspeed="1500" data-thumb="haswell/images/revo-slider/rs-fullscr-thumb3.jpg"  data-saveperformance="on"  data-title="WELCOM">
									
                  <!-- MAIN IMAGE -->
									<img src="haswell/images/revo-slider/dummy.png"  alt="citybg" data-lazyload="haswell/images/revo-slider/slide_1_3.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
					...
					<div class="container fes1-cont">
						<div class="row">
							...
							<div class="col-md-4 fes1-img-cont wow fadeInUp mb-20">
								<img src="haswell/images/phone-with-arrow.png" alt="img" >
							</div>
            ...
            <ul class="port-grid port-grid-3 port-grid-gut clearfix" id="items-grid">
              ...
              <li class="port-item mix">
                <a href="portfolio-single1.html">
                  <div class="port-img-overlay"><img class="port-main-img" src="haswell/images/portfolio/projects-5.jpg" alt="img" ></div>
                </a>
                <div class="port-overlay-cont">
                    ...
                    <div class="port-btn-cont">
                      <a href="haswell/images/portfolio/projects-2-big.jpg" class="lightbox mr-20" ><div aria-hidden="true" class="icon_search"></div></a>
              ...
              <li class="port-item mix">
                <a href="portfolio-single1.html">
                  <div class="port-img-overlay">
                    <img class="port-main-img" src="haswell/images/portfolio/projects-3.jpg" alt="img" >
                  </div>
                </a>
                <div class="port-overlay-cont">
              ...
              <li class="port-item mix">
                <a href="portfolio-single1.html">
                  <div class="port-img-overlay">
                    <img class="port-main-img" src="haswell/images/portfolio/projects-1.jpg" alt="img" >
                  </div>
                </a>
                <div class="port-overlay-cont">
              ...
              <li class="port-item mix">
                <a href="portfolio-single1.html">
                  <div class="port-img-overlay">
                    <img class="port-main-img" src="haswell/images/portfolio/projects-6.jpg" alt="img" >
                  </div>
                </a>
                <div class="port-overlay-cont">
              ...
              <li class="port-item mix">
                <a href="portfolio-single1.html">
                  <div class="port-img-overlay">
                    <img class="port-main-img" src="haswell/images/portfolio/projects-7.jpg" alt="img" >
                  </div>
                </a>
                <div class="port-overlay-cont">
              ...
              <li class="port-item mix">
                <a href="portfolio-single1.html">
                  <div class="port-img-overlay">
                    <img class="port-main-img" src="haswell/images/portfolio/projects-4.jpg" alt="img" >
                  </div>
                </a>
                <div class="port-overlay-cont">
        ...
        <div class="page-section p-110-cont">
              ...
              <div class="col-md-7">
                <div class="row client-row border-bot">
                    ...
                    <div class="col-xs-6 col-sm-3 text-center">
                      <img alt="client" src="haswell/images/clients/1.png">
                    </div>
                  
                    <div class="col-xs-6 col-sm-3 text-center">
                      <img alt="client" src="haswell/images/clients/2.png">
                    </div>
                  
                    <div class="col-xs-6 col-sm-3 text-center">
                      <img alt="client" src="haswell/images/clients/3.png">
                    </div>
                  
                    <div class="col-xs-6 col-sm-3 text-center">
                      <img alt="client" src="haswell/images/clients/4.png">
                    </div>
                ...
                <div class="row client-row">
                    ...
                    <div class="col-xs-6 col-sm-3 text-center">
                      <img alt="client" src="haswell/images/clients/5.png">
                    </div>
                  
                    <div class="col-xs-6 col-sm-3 text-center">
                      <img alt="client" src="haswell/images/clients/6.png">
                    </div>
                  
                    <div class="col-xs-6 col-sm-3 text-center">
                      <img alt="client" src="haswell/images/clients/7.png">
                    </div>
                  
                    <div class="col-xs-6 col-sm-3 text-center">
                      <img alt="client" src="haswell/images/clients/8.png">
                    </div>
            ...
            <div class="row">
              <div class="col-md-12 text-center wow fadeInUp" data-wow-duration="1s">
                <img src="haswell/images/team/team-all.jpg" alt="img">
              </div>
            </div>
          ...
          <div class="container">
            ...
            <div  class="row text-center">
              ...
              <div class="col-md-6 right-50 wow fadeInLeft">
                    ...
                    <img src="haswell/images/ads-phone.jpg" alt="img">
                  </div>
              ...
              <div class="col-md-6 wow fadeInRight">
									...
									<div class="ads-img-cont" >
                    <img src="haswell/images/ads-noute.jpg" alt="img">
                  </div>
            ...
            <div class="row">
              ...
              <div class="col-md-3 col-sm-3 widget">
                <div class="logo-footer-cont">
                  <a href="index.html">
                    <img class="logo-footer" src="haswell/images/logo-footer.png" alt="logo">
                  </a>
                </div>
